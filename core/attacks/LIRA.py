...
class LIRA(Base):
    ...
    def create_net(self):
        ...
        if self.dataset_name == 'mnist':
            ...
            def create_cifar():
                return models.ResNet(18, num_classes=10) # core.models.vgg11(num_classes=10) #core.models.ResNet(18)
            return create_cifar
        elif self.dataset_name == 'gtsrb':
            def create_gtsrb():
                return models.MobileNetV2(num_classes=43) # core.models.vgg11(num_classes=43) #core.models.ResNet(18, 43)
            return create_gtsrb
    ...
    def train(self, schedule=None):
        ...
        work_dir = osp.join(self.current_schedule['save_dir'], self.current_schedule['experiment_name'] + '_' + time.strftime("%Y-%m-%d", time.localtime()))
